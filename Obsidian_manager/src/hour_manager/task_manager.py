...
class TaskManager:
    ...
    def task_manager(self, file, lines, tasks_path, file_name):
        tasks_dict = dict()
    ...
    def file_manager(self, tasks_path):
        """
        ...
        for file_name in os.listdir(tasks_path):
            ...
            if file_name.endswith('.md'):
                ...
                with open(file_path, 'r+', encoding="utf-8") as file:
                    ...
                    return self.task_manager(file, lines, tasks_path, file_name)
...
class TasksUnchecker:
    ...
    def file_parser(self, file, lines, date_format):
        replaced_lines = []
        ...
        for line in lines:
            ...
            return replaced_lines, date_was_updated

    def uncheck_tasks(self, path, date_format):
        # Открываем файл в режиме чтения и записи
        with open(path, 'r+', encoding="utf-8") as file:
            lines = file.readlines()

            replaced_lines, date_was_updated = self.file_parser(file, lines, date_format)
