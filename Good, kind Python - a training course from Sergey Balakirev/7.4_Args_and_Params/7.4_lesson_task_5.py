...
# параметров tag с начальным значением в виде строки "h1". Например, мы передаем строку "Hello Python" и заключаем в
# тег "h1". На выходе должны получить строку (без кавычек):
# "<h1>Hello Python</h1>"
...
def wrap_text_in_tag(text, tag='h1'):
    result = f"<{tag}>{text}</{tag}>"
    return result


input_string = input()
print(wrap_text_in_tag(input_string))
