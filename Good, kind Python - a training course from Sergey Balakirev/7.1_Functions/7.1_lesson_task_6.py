# Подвиг 6. Объявите функцию, которая принимает список, находит максимальное, минимальное и сумму значений этого
# списка и выводит результат в виде строки (без кавычек):
...
def find_max_min_and_sum(bill):
    print(f"Min = {min(bill)}, max = {max(bill)}, sum = {sum(bill)}")


lst = list(map(int, input().split()))
find_max_min_and_sum(lst)