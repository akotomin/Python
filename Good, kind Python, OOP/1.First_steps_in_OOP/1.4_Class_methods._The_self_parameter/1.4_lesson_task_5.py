...
# Метод draw() должен выводить на экран список в виде строки из чисел, разделенных пробелами и принадлежащие заданному
# диапазону атрибута LIMIT_Y (границы включаются).
...
class Graph:
    ...
    def draw(self):
        lst = [i for i in self.data if self.LIMIT_Y[0] <= i <= self.LIMIT_Y[1]]
        print(*lst)
